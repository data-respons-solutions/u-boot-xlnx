...
static int do_rauc_test(cmd_tbl_t *cmdtp, int flag, int argc, char *const argv[])
{
	uint32_t len = 379;
...
static int do_rauc_list(cmd_tbl_t *cmdtp, int flag, int argc, char *const argv[])
{
	rauc_nvram_list(1);
	return 0;
}

static int do_rauc_get(cmd_tbl_t *cmdtp, int flag, int argc, char *const argv[])
{
	char val[256];
	if (argc == 0)
		return -EINVAL;
...
static int do_rauc_clear(cmd_tbl_t *cmdtp, int flag, int argc, char *const argv[])
{
	int r = nvram_clear();
	if (r < 0)
		pr_err("%s failed (%d)\n", __func__, r);
...
static int do_rauc_set(cmd_tbl_t *cmdtp, int flag, int argc, char *const argv[])
{
	if (argc < 2)
		return -EINVAL;
...
static int do_rauc_del(cmd_tbl_t *cmdtp, int flag, int argc, char *const argv[])
{
	if (argc < 1)
		return -EINVAL;
...
static int do_rauc_commit(cmd_tbl_t *cmdtp, int flag, int argc, char *const argv[])
{
	int r = nvram_commit(&nv_list);
	return r;
}

static int do_rauc_boot(cmd_tbl_t *cmdtp, int flag, int argc, char *const argv[])
{
	int r = rauc_boot();
	return r;
}

static int do_rauc_init(cmd_tbl_t *cmdtp, int flag, int argc, char *const argv[])
{
	int r = rauc_defaults();
	return r;
}

static cmd_tbl_t rauc_commands[] = {
...
static int do_rauc(cmd_tbl_t *cmdtp, int flag, int argc, char *const argv[])
{
	cmd_tbl_t *rauc_cmd;
